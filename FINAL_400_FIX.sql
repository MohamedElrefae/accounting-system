-- ================================================
-- FINAL 400 ERROR FIX - Handles Missing Columns
-- This version checks and adds missing columns first
-- ================================================
...
-- 10. Add sample data to avoid empty results (after columns are created)
...
SELECT 'PROJECTS COLUMNS:' as info, column_name 

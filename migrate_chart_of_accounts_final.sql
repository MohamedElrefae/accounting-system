-- Migration Script: Replace Chart of Accounts with Arabic Version (Final)
-- Created: 2025-08-24
-- Source: chart-of-accounts.txt
-- Handles unique constraints and duplicate names

BEGIN;

-- Step 1: Clear existing accounts completely (safe since no transactions exist)
-- First, clear any references in other tables if they exist
DELETE FROM transaction_audit WHERE transaction_id IN 
    (SELECT id FROM transactions WHERE debit_account_id IN 
        (SELECT id FROM accounts WHERE org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145') OR
     credit_account_id IN 
        (SELECT id FROM accounts WHERE org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'));

DELETE FROM transactions WHERE org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145';

-- Now clear accounts
DELETE FROM accounts WHERE org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145';

-- Step 2: Insert new Arabic chart of accounts with unique names
...
-- Level 3 Accounts (Sub-sub-categories) - Making names unique
INSERT INTO accounts (id, org_id, code, name, name_ar, level, category, parent_id, is_postable, status, created_at, updated_at) VALUES
...
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '1203', 'جارى المساهمين - مدين', 'جارى المساهمين - مدين', 3, 'asset', (SELECT id FROM accounts WHERE code = '12' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), false, 'active', now(), now()),
...
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '2303', 'جارى المساهمين - دائن', 'جارى المساهمين - دائن', 3, 'liability', (SELECT id FROM accounts WHERE code = '23' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), false, 'active', now(), now()),
...
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '3204', 'فروق تقييم عملة - ايراد', 'فروق تقييم عملة - ايراد', 3, 'revenue', (SELECT id FROM accounts WHERE code = '32' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
...
-- Level 4 Accounts (Detailed accounts) - Ensuring unique names
...
INSERT INTO accounts (id, org_id, code, name, name_ar, level, category, parent_id, is_postable, status, created_at, updated_at) VALUES
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '110201', 'مشروع جيفيرا - تحت التنفيذ', 'مشروع جيفيرا - تحت التنفيذ', 4, 'asset', (SELECT id FROM accounts WHERE code = '1102' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '110202', 'مشروع السعودية - تحت التنفيذ', 'مشروع السعودية - تحت التنفيذ', 4, 'asset', (SELECT id FROM accounts WHERE code = '1102' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '110203', 'مشروع BMA - تحت التنفيذ', 'مشروع BMA - تحت التنفيذ', 4, 'asset', (SELECT id FROM accounts WHERE code = '1102' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now());
...
-- Shareholders Accounts (Assets) Level 4
INSERT INTO accounts (id, org_id, code, name, name_ar, level, category, parent_id, is_postable, status, created_at, updated_at) VALUES
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120301', 'د أحمد البيطار - مدين', 'د أحمد البيطار - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1203' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120302', 'أ محمد السيد - مدين', 'أ محمد السيد - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1203' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120303', 'د امنية رضا - مدين', 'د امنية رضا - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1203' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now());

-- Debit Balances Level 4
INSERT INTO accounts (id, org_id, code, name, name_ar, level, category, parent_id, is_postable, status, created_at, updated_at) VALUES
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120501', 'مصلحة الضرائب - ضرائب الدخل - مدين', 'مصلحة الضرائب - ضرائب الدخل - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1205' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120502', 'ضرائب القيمة المضافة - مدين', 'ضرائب القيمة المضافة - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1205' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120503', 'ضرائب الخصم والاضافة - مدين', 'ضرائب الخصم والاضافة - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1205' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120504', 'ضرائب كسب العمل - مدين', 'ضرائب كسب العمل - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1205' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120505', 'التأمينات الاجتماعية - مدين', 'التأمينات الاجتماعية - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1205' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120506', 'التأمين الصحى الشامل - مدين', 'التأمين الصحى الشامل - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1205' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '120507', 'ضرائب المنبع - مدين', 'ضرائب المنبع - مدين', 4, 'asset', (SELECT id FROM accounts WHERE code = '1205' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now());
...
INSERT INTO accounts (id, org_id, code, name, name_ar, level, category, parent_id, is_postable, status, created_at, updated_at) VALUES
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230301', 'د أحمد البيطار - دائن', 'د أحمد البيطار - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2303' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230302', 'أ محمد السيد - دائن', 'أ محمد السيد - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2303' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230303', 'د امنية رضا - دائن', 'د امنية رضا - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2303' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now());

-- Credit Balances Level 4
INSERT INTO accounts (id, org_id, code, name, name_ar, level, category, parent_id, is_postable, status, created_at, updated_at) VALUES
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230401', 'مصلحة الضرائب - ضرائب الدخل - دائن', 'مصلحة الضرائب - ضرائب الدخل - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2304' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230402', 'ضرائب القيمة المضافة - دائن', 'ضرائب القيمة المضافة - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2304' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230403', 'ضرائب الخصم والاضافة - دائن', 'ضرائب الخصم والاضافة - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2304' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230404', 'ضرائب كسب العمل - دائن', 'ضرائب كسب العمل - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2304' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230405', 'التأمينات الاجتماعية - دائن', 'التأمينات الاجتماعية - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2304' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '230406', 'التأمين الصحى الشامل - دائن', 'التأمين الصحى الشامل - دائن', 4, 'liability', (SELECT id FROM accounts WHERE code = '2304' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),
...
(gen_random_uuid(), '4cbba543-eb9c-4f32-9c77-155201f7e145', '4203', 'فروق عملة - مصروف', 'فروق عملة - مصروف', 3, 'expense', (SELECT id FROM accounts WHERE code = '42' AND org_id = '4cbba543-eb9c-4f32-9c77-155201f7e145'), true, 'active', now(), now()),

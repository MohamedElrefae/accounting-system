...
foreach ($branch in $branches) {
    ...
    if ($hasChanges) {
        ...
        # Commit
        git commit -m "chore: Commit pending work on $branch branch"
...
# Save to file
$results | ConvertTo-Json | Out-File "branch_scan_results.json"
Write-Host "`nResults saved to branch_scan_results.json" -ForegroundColor Green

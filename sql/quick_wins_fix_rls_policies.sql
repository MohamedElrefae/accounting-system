-- ============================================================================
-- QUICK WINS: Fix RLS Policies (IMMEDIATE SECURITY FIX)
-- ============================================================================
...
-- BACKUP CURRENT POLICIES FIRST
-- ============================================================================
-- Run this query and save the results before making changes:
/*
SELECT 
  schemaname,
  tablename,
...
-- Remove old policy if exists (safe to run even if table doesn't exist)

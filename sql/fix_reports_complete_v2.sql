-- ============================================================================
-- Complete Reports System Fix v2
...
-- ============================================================================
-- 3. Populate fields from allowed_fields (separate statement after column exists)
-- ============================================================================
DO $$
BEGIN
  -- Only run if fields column exists and allowed_fields has data
  IF EXISTS (
    SELECT 1 FROM information_schema.columns 
    WHERE table_name = 'report_datasets' AND column_name = 'fields'
  ) THEN

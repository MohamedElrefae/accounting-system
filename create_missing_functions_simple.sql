-- Simplified version for Enterprise Running Balance page
-- Uses only basic columns that should exist in transaction_lines
...
-- Create a simplified function using only essential transaction_lines columns
...
-- Grants for the simplified function
...
-- Verification query
SELECT 
  'get_gl_account_summary_filtered function created successfully (simplified version)' as status,
  now() as created_at;

...
-- Impact: App cannot load organizations/projects (500 errors)
-- Solution: Simplify RLS policies, use SECURITY DEFINER functions
-- =====================================================
...
-- Step 4: Create safe policies using SECURITY DEFINER functions
...
-- System Roles Policies (no recursion!)
...
-- Step 5: Update organizations RLS policies

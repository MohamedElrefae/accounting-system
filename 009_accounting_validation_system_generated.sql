-- 009_accounting_validation_system_generated.sql
-- Comprehensive validation system to prevent backwards/incorrect journal entries
-- FINAL VERSION: Works with generated normal_balance column

BEGIN;

-- 1) No need to update normal_balance since it's a generated column
-- It's automatically calculated based on the account category

-- Complete fix for Enterprise Running Balance page
-- Creates the missing get_gl_account_summary_filtered function with correct signature
...
-- Create the complete get_gl_account_summary_filtered function
-- This is the extended version from migration 054 with all the filters
...
-- Grants for the extended function
...
-- Verification query
SELECT 
  'get_gl_account_summary_filtered function created successfully' as status,
  now() as created_at;

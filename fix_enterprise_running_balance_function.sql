...
-- This creates the compatibility wrapper that forwards to the main function
...
as $$
  select * from public.get_gl_account_summary(
    ...
    p_cost_center_id => coalesce(p_cost_center_id, p_expenses_category_id),
    p_work_item_id => p_analysis_work_item_id,
    p_expenses_category_id => p_expenses_category_id,

-- 061_gl_details_expenses_category_filter.sql
-- Add expenses category filtering to get_general_ledger_report_filtered function

BEGIN;

-- Update the GL details function to include expenses_category_id parameter and filtering
...
AS $$
  WITH tx_rows AS (
    ...
    WHERE TRUE
      ...
      AND (p_expenses_category_id IS NULL OR t.expenses_category_id = p_expenses_category_id)
      AND (

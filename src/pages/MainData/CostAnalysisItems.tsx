  ...
  return (
    <div className="page-root flex-col gap-4">
      <div className="page-header flex-row items-center justify-between">
        <div>
          <h2 className="text-title">إدارة بنود المعاملات</h2>
        ...
        <div className="flex-row gap-2 items-center">
          ...
          >
            <option value="">اختر معاملة للتعديل...</option>
      ...
      {!currentTransactionId ? (
        <div className="empty-state text-center py-12">
          ...
          <h3 className="text-xl font-bold mb-2">اختر معاملة لبدء إدارة بنودها</h3>
...
export default CostAnalysisItems
